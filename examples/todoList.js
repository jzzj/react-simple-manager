...
var ListManager = function (_StateManager) {
    _inherits(ListManager, _StateManager);

    function ListManager() {
        _classCallCheck(this, ListManager);

        return _possibleConstructorReturn(this, (ListManager.__proto__ || Object.getPrototypeOf(ListManager)).apply(this, arguments));
    }

    _createClass(ListManager, [{
        key: "last",
        value: function last(num) {
...
var ListStore = new _lib.StoreManager({
    list: "asdfxbmklfs".split("")
});

var FakeReactView = function () {
    function FakeReactView() {
        _classCallCheck(this, FakeReactView);
    }

    _createClass(FakeReactView, [{
        key: "componentWillMount",
        value: function componentWillMount() {
            this.manager = new _lib.ViewManager(ListStore, ListManager);
            this.manager.bindView(this);
            return this.manager;
        }
    }]);

    return FakeReactView;
}();
...
},{"./ViewManager":4}],3:[function(require,module,exports){
'use strict';
...
},{"immutable":6}],4:[function(require,module,exports){
'use strict';
...
var ViewManager = function () {
    ...
    _createClass(ViewManager, [{
        ...
        key: '__updateView',
        value: function __updateView(update) {
            if (!this.__ready) {
...
},{"./StateManager":2}],5:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ViewManager = exports.StateManager = exports.StoreManager = undefined;
...
},{"./StateManager":2,"./StoreManager":3,"./ViewManager":4}],6:[function(require,module,exports){
/**
